-- module Drawer exposing (class, classList, conversationList, conversationListElement, details, detailsContaier, drawer, drawerPosition, id, isFocused, leftMenu, searchArea, searchField)
...
--         , (\( a, b ) -> style a b) (drawerPosition model.leftMenuOpen)
--         ]
--         [ --verticalToolbar
--           details model
--         ]
...
-- details model =
--     div [ style "background-color" "#171717", style "display" "flex", style "flex-direction" "column", style "min-width" "250px", style "max-width" "420px", style "height" "100%" ]
--         [ div [ class [ ChatCss.ElevationBorder ], style "padding-top" "8px", style "padding-bottom" "4px", style "padding-left" "15px", style "padding-right" "15px" ]
--             [ searchField model ]
...
--                 [ input [ style "type" "text", style "padding-top" "10px", style "padding-bottom" "10px", style "border-radius" "5px", class [ ChatCss.Input ], placeholder "Find or start a conversation", onInput SetNewMessage, value model.newMessage.message ] []
--                 ]
--             ]
--         ]
